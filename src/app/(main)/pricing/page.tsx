...
export default function Page() {
  return (
    <section className="container grid items-center gap-6 pt-6 pb-8 md:py-10">
      ...
      <div className="mx-auto mt-8 grid max-w-2xl grid-cols-2 gap-16 ">
        <div className="flex flex-col rounded-xl border border-slate-300 p-10">
          <h2>
        ...
        <div className="flex flex-col  rounded-xl bg-slate-900 p-10 text-white">
          <h2>
