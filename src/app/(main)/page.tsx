...
export default async function Home({
  ...
  return (
    <>
      ...
      <section className="container relative grid items-center gap-6 pt-6 pb-8 md:py-10">
        <div className="absolute inset-x-0 top-20 bottom-0 z-0 mx-auto w-1/2 rounded-full bg-blue-500/50 blur-[100px]" />
        <div className="z-10 mx-auto mt-10 flex max-w-[980px] flex-col items-center gap-2 md:mt-20">
          ...
          <p className="mt-2 max-w-[700px] text-center text-lg text-slate-800 sm:text-lg md:mt-4">
            Custom chatbot powered by ChatGPT API based on your content.
            <br className="hidden sm:inline" /> Deploy it on your website in
            minutes.
          </p>
        </div>
        <div className="z-10 flex items-center justify-center gap-4 md:mt-8">
          {session ? (
